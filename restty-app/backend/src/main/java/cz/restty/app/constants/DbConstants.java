package cz.restty.app.constants;

/**
 * Class that contains all database constants.
 * 
 * @author Ondrej Krpec
 *
 */
public class DbConstants {
    ...
    public static final String PARAMETER_SEQUENCE = "parameter_id_sequence";
    public static final String PROJECT_SEQUENCE = "project_id_sequence";
    public static final String TEST_CASE_SEQUENCE = "test_case_id_sequence";
    public static final String RESPONSE_SEQUENCE = "response_id_sequence";
