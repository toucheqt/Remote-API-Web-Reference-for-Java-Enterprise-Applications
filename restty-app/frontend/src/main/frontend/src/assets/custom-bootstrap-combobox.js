...
!function( $ ) {
 ...
 var $element;
  ...
  var Combobox = function ( element, options ) {
    ...
    this.$button = $container.find('.dropdown-toggle');
  ...
  , transferAttributes: function() {
    this.options.placeholder = $source.attr('data-placeholder') || this.options.placeholder
    if(this.options.appendId !== "undefined") {
    	$element.attr('id', $source.attr('id') + this.options.appendId);
    }
    ...
    if ($source.attr('disabled')!==undefined)
      this.disable();
  }

  , select: function () {
      var val = this.$menu.find('.active').attr('data-value');
      $element.val(this.updater(val)).trigger('change');
      $target.val(this.map[val]).trigger('change');
      $source.val(this.map[val]).trigger('change');
      $container.addClass('combobox-selected');
      selected = true;
      return this.hide();
    }
